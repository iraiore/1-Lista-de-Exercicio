...
namespace exercicio2
{
    public class Program
    {
        public static void Main (string[] args)
        {
            ...
            Console.WriteLine("Entre como o código e o numero de horas trabalhadas do operador: ");//entrada pelo usuario
            ...
            if(N>50)//inicio da estrutura de seleção if - somente sera executada se o que estiver dentro do if for verdade
            {
                SHN = 50*10;
                E  = (N-50)*20;
                ST = SHN+E;
            ...
            {
                SHN = 50*10;
                Console.WriteLine("Não houve salário excedente. O salário do colaborador, referente a horas normais é: R$: "+SHN);
            }
        }
    }
}